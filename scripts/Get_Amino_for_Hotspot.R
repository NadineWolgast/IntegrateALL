...
mutations <- data.frame(
  ...
  Chromosome = c("chr2", "chr2", "chr12", "chr12", "chr12", "chr12", "chr1", "chr1", "chr1", "chr1", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13",
                 "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13",
                 "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr13", "chr9"),
...
find_CHROM_row <- function(file_path, chrom_val, pos_val) {
  ...
  headers <- c("X.CHROM", "POS", "ID", "REF", "ALT", "QUAL", "FILTER", "INFO", "FORMAT", "J00708")
  colnames(df) <- headers
  #print(names(df))
  #print("vor subset")
...
#vcf = pd.read_csv(ctat_file, skiprows=skip-1, header=0, sep="\t")
